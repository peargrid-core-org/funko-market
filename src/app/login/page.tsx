      ...
      <main className="flex-1 bg-background flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-3xl text-foreground">Bienvenido de vuelta</h1>
            <p className="mt-2 text-muted">Entra en tu cuenta de FunkoMarket</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-border-light p-8" style={{ boxShadow: "var(--card-shadow)" }}>
            <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a href="#" className="text-xs text-primary hover:text-primary-dark transition-colors">¿Olvidaste la contraseña?</a>
                </div>
                <input
                  type="password"
                  placeholder="••••••••"
            ...
            <div className="mt-6 relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-4 text-muted">o continúa con</span>
              </div>
            </div>

            <button className="mt-6 w-full h-12 flex items-center justify-center gap-3 border border-border rounded-xl hover:bg-surface-alt/50 transition-colors text-sm font-medium text-foreground">
          ...
          <p className="mt-6 text-center text-sm text-muted">
            ¿No tienes cuenta?{" "}
            <Link href="/registro" className="font-semibold text-primary hover:text-primary-dark transition-colors">
              Crear cuenta gratis
            </Link>
          </p>
        </div>
